...
SECRET_KEY = 'django-insecure-l5^q1s8@48l6b!i-9txczueb92@k7#tq^%uyf=-v!_i+f%3zez'
...
# STATICFILES_DIRS используется для указания дополнительных директорий для поиска статических файлов
STATICFILES_DIRS = [
