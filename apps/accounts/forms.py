...
class UserRegisterForm(forms.ModelForm):
    ...
    password1 = forms.CharField(widget=forms.PasswordInput, label="Введите ваш пароль")
    password2 = forms.CharField(widget=forms.PasswordInput, label="Введите ваш пароль ещё раз")
...
=======
>>>>>>> 6a31141adf5422686828351d6b3382fb9558c73e
