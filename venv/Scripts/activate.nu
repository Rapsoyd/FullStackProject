...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\PycharmProjects\Django_for_beginners\blog_cbv\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\PycharmProjects\Django_for_beginners\blog_cbv\venv\Scripts\deactivate.nu'
